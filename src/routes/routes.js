...
const {createRoom,addMember,renameRoom,removeMember,getAllRooms,searchRoom,getRoomByRoomId,joinRoom,searchOpenRooms} = require('../controller/roomController/roomController')
...
router.post('/searchRoom',authentication, searchRoom)
router.get('/getroom/:roomId',authentication ,getRoomByRoomId)
router.post('/joinRoom/:roomId',authentication ,joinRoom)
router.get('/findRoom',authentication ,searchOpenRooms)
